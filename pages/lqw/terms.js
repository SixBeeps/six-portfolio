export default function Terms() {
	return <div className="expandpage main-content">
		<div className="main-content">
			<h1>LQWBOT TERMS OF SERVICE AGREEMENT</h1>
			<p>This Terms of Service Agreement (the &quot;Agreement&quot;) is entered into between Brandon Lee (&quot;Bot Owner&quot;) and the user (&quot;User&quot;) of the LQWBot Discord bot (the &quot;Bot&quot;).</p>
			...
			<ol>
				...
				<li>Governing Law: This Agreement shall be governed by and construed in accordance with the laws of the United States of America. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of [Your arbitration provider].</li>
